...
from django.contrib.auth.decorators import login_required #ログイン必須のアノテーションを有効化
...
def groups(request):
    ...
    if request.method == 'POST':
        ...
        if request.POST['mode']=='__friends_form__':
            ...
            # メッセージを設定
            messages.success(request,f'チェックされたFriendを{sel_group}に登録しました')    #この表記OK
